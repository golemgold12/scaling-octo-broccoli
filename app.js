    ...
    db.pool.query(query1, function (error1, RestaurantRows, fields1) {
        ...
        db.pool.query(query2, function (error2, reviewRows, fields2) {
            ...
            res.render('restauraunts', {
                data: RestaurantRows, review: reviewRows  // technicall you dont need latter but i will use it
            });
        ...
        db.pool.query(restaurantQuery, [restaurantId], function (restaError, restaurant_Name, fields2){
            if (restaError) {
                ...
                res.render('reviewPage', {
                    rName: selectedName, review: foundReviews  // technicall you dont need latter but i will use it
                });
...
app.post('/add-review-ajax', function(req, res) 
{
    ...
    query1 = `INSERT INTO Review (restaurant_Id, rating, reviewer, comments, is_Verified) VALUES ('${data.restaurant_Id}', '${data.rating}', '${data.reviewer}', '${data.comments}', 1)`;
...
app.post('/add-restaurant-ajax', function(req, res) 
{
    ...
    console.log(data);
    // Create the query and run it on the database
    query1 = `INSERT INTO Restaurant (restaurant_Name, phone, is_Open) VALUES ('${data.restaurant_Name}', '${data.phone}', '${data.is_Open}')`;
    db.pool.query(query1, function(error, rows, fields){
